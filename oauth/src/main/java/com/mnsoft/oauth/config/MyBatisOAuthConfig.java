 ...
 */
@Configuration
@MapperScan(basePackages =  "com.mnsoft.oauth.mapper", sqlSessionFactoryRef = "sqlSessionFactoryBeanForOAuth")
...
//        return DataSourceBuilder.create().build();
    ...
    public SqlSessionFactory sqlSessionFactoryBeanForOAuth(@Qualifier("dataSourceOAuth") DataSource dataSource) throws Exception {
        ...
        factory.setTypeAliasesPackage("com.mnsoft.oauth.model");
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.mnsoft.oauth.mapper");
