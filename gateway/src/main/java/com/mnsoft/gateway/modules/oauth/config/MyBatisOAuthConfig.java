 ...
 */
@Configuration
@MapperScan(basePackages =  "com.mnsoft.gateway.modules.oauth.mapper", sqlSessionFactoryRef = "sqlSessionFactoryBeanForOAuth")
public class MyBatisOAuthConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryBeanForOAuth(@Qualifier("dataSourceOAuth") DataSource dataSource) throws Exception {
        ...
        factory.setTypeAliasesPackage("com.mnsoft.gateway.modules.oauth.model");
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.mnsoft.gateway.modules.oauth.mapper");
