package com.mnsoft.gateway.modules.oauth.config;
 ...
 */
@Configuration
@MapperScan(basePackages =  "com.mnsoft.gateway.modules.oauth.modules.client.mapper", sqlSessionFactoryRef = "sqlSessionFactoryBeanForClient")
public class MyBatisClientConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryBeanForClient(@Qualifier("dataSourceClient") DataSource dataSource) throws Exception {
        ...
        factory.setTypeAliasesPackage("com.mnsoft.gateway.modules.oauth.modules.client.model");
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.mnsoft.gateway.modules.oauth.modules.client.mapper");
