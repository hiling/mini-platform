...
import com.github.hiling.auth.constant.GrantType;
import com.github.hiling.auth.constant.RedisNamespaces;
import com.github.hiling.auth.mapper.AccessTokenMapper;
...
import com.github.hiling.auth.modules.client.mapper.ClientMapper;
import com.github.hiling.auth.modules.client.model.Client;
import com.github.hiling.auth.task.RemoveAccessTokenThread;
import com.github.hiling.auth.task.RemoveRefreshTokenThread;
...
public class AccessTokenServiceImpl implements AccessTokenService {
    ...
    public boolean deleteToken(String accessToken) {
        ...
        if (StringUtils.isNotEmpty(refreshToken)) {
            accessTokenMapper.batchDeleteByAccessToken(Collections.singletonList(accessToken));
            refreshTokenMapper.batchDeleteByRefreshToken(Collections.singletonList(refreshToken));
        }
        return true;
    }
