package com.github.hiling.auth.config;
 ...
 */
@Configuration
@MapperScan(basePackages =  "com.github.hiling.auth.modules.client.mapper", sqlSessionFactoryRef = "sqlSessionFactoryBeanForClient")
public class MyBatisClientConfig {
    ...
    public SqlSessionFactory sqlSessionFactoryBeanForClient(@Qualifier("dataSourceClient") DataSource dataSource) throws Exception {
        ...
        factory.setTypeAliasesPackage("com.github.hiling.auth.modules.client.model");
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.github.hiling.auth.modules.client.mapper");
